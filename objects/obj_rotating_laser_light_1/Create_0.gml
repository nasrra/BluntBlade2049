...
lights[0].initialise(light_size, colour,    light_fov);
lights[1].initialise(light_size, colour,    light_fov);
lights[2].initialise(light_size, colour,     light_fov);
lights[3].initialise(light_size, colour,  light_fov);
