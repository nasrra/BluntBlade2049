...
function audiomanager_play_explosion_bomb(){
    var i = irandom_range(0,2);
    switch(i){
        case 0:
            audio_play_sound(snd_explosion_bomb_1,0,false,1,0,random_range(0.8,1));
            break;
        case 1:
            audio_play_sound(snd_explosion_bomb_2,0,false,1,0,random_range(0.8,1));
            break;
        case 2:
            audio_play_sound(snd_explosion_bomb_3,0,false,1,0,random_range(0.8,1));
            break;
    }
}

function audiomanager_play_explosion_electric(){
    var i = irandom_range(0,1);
    switch(i){
        case 0:
            audio_play_sound(snd_explosion_electric_1,0,false,1,0,random_range(0.8,1));
            break;
        case 1:
            audio_play_sound(snd_explosion_electric_2,0,false,1,0,random_range(0.8,1));
            break;
    }
}
